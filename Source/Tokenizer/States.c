...
// State float_sign_state          = {false, NA,    NA,        &transition_from_float_sign};
// State float_digit_state         = {true,  true,  "float",   &transition_from_float_digit};
// State float_dot_state           = {true,  true,  "float",   &transition_from_float_dot};
// State float_decimals_state      = {true,  true,  "float",   &transition_from_float_decimals};
