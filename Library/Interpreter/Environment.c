...
Environment* environment_create_default ()
{
    ...
    environment_set(env, "display", value_create_keyword(&function_display));
    ...
    environment_set(env, ">",       value_create_function(&function_greaterthan));
    environment_set(env, ">=",      value_create_function(&function_greaterthaneqto));
    environment_set(env, "<",       value_create_function(&function_lessthan));
    environment_set(env, "<=",      value_create_function(&function_lessthaneqto));
